...
export const ExperiencePortfolio = () => {
  ...
  return (
    <div className="experience-portfolio w-full base-rounded h-[160vh] md:h-[150vh] px-5 py-5 flex flex-col gap-y-8">
      ...
      <div className="portfolio-row flex flex-col md:flex-row md:flex-wrap gap-8">
        {dataPortfolio &&
          dataPortfolio.map((p) => {
            return p ? (
